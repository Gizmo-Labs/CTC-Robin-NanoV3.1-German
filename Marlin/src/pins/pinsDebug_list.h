...
/** 
 * Alle Pins in dieser Liste werden von pinsDebug.h ausgelesen
 * und dann in den EEPROM geschrieben, damit die Konfiguration
 * auf dem Board gespeichert ist.
*/
