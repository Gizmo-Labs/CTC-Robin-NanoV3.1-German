...
namespace Language_de {
  ...
  LSTR MSG_MEDIA_USB_REMOVED              = _UxGT("USB Stick entfernt");
  ...
  LSTR MSG_MAIN                           = _UxGT("Hauptfenster");
  ...
  LSTR MSG_DEBUG_MENU                     = _UxGT("Debug-Fenster");
  ...
  LSTR MSG_LEVEL_BED_NEXT_POINT           = _UxGT("Naechste Koordinate");
  LSTR MSG_LEVEL_BED_DONE                 = _UxGT("Nivellieren fertig!");
  LSTR MSG_Z_FADE_HEIGHT                  = _UxGT("Ausblendhoehe");
  ...
  LSTR MSG_COOLDOWN                       = _UxGT("Abkuehlen");
  ...
  LSTR MSG_NEXT_CORNER                    = _UxGT("Naechste Ecke");
  ...
  LSTR MSG_CUSTOM_COMMANDS                = _UxGT("Benutzer-Menue");
  ...
  LSTR MSG_IDEX_MODE_FULL_CTRL            = _UxGT("Totale Kontrolle");
  LSTR MSG_HOTEND_OFFSET_X                = _UxGT("2. Duese X");
  LSTR MSG_HOTEND_OFFSET_Y                = _UxGT("2. Duese Y");
  LSTR MSG_HOTEND_OFFSET_Z                = _UxGT("2. Duese Z");
  LSTR MSG_UBL_DOING_G29                  = _UxGT("G29 ausfuehren");
  LSTR MSG_UBL_TOOLS                      = _UxGT("UBL-Werkzeuge");
  LSTR MSG_UBL_LEVEL_BED                  = _UxGT("Unified Bed Leveling");
  LSTR MSG_LCD_TILTING_MESH               = _UxGT("Beruehrungspunkt");
  ...
  LSTR MSG_UBL_MOVING_TO_NEXT             = _UxGT("Naechster Punkt...");
  ...
  LSTR MSG_UBL_MESH_HEIGHT_ADJUST         = _UxGT("Netzhoehe einst.");
  LSTR MSG_UBL_MESH_HEIGHT_AMOUNT         = _UxGT("Hoehe");
