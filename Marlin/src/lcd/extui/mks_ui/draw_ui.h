...
// Hintergrundfarbe UI
#define LV_COLOR_BACKGROUND LV_COLOR_MAKE(0x1A, 0x20, 0x27)
// ToDo...
#define TFT_LV_PARA_BACK_BODY_COLOR  LV_COLOR_MAKE(0xC0, 0xC0, 0xC0)
// ToDo...
#define PARA_SEL_ICON_TEXT_COLOR  LV_COLOR_MAKE(0xC0, 0xC0, 0xC0);
...
// USB-Laufwerk als Default-Medium
#define FILE_SYS_USB      1
#define FILE_SYS_SD       0
