...
extern lv_group_t *g;
static lv_obj_t *scr;
static lv_obj_t *fw_type, *board, *display;
...
void lv_draw_about() {
  ...
  board = lv_label_create(scr, "Platine: " BOARD_INFO_NAME);
  lv_obj_align(board, nullptr, LV_ALIGN_CENTER, 0, -60);

#if ENABLED(MKS_TS35_V2_0)
  display = lv_label_create(scr, "Display: Makerbase TS35 V2.0" );
  lv_obj_align(display, nullptr, LV_ALIGN_CENTER, 0, -100);
#endif
}
