...
#define TEXT_VALUE_mm       ": %d mm"
#define TEXT_VALUE_cm       ": %d cm"
#define TEXT_VALUE_m        ": %d m"
...
#define HOME_ALL_TEXT       "Alle"

#define ABOUT_TYPE_TEXT     "Gizmo Labs"
