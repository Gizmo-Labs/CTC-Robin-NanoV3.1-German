...
void lv_draw_error_message(PGM_P const msg) {
  ...
  disp_string((TFT_WIDTH - strlen("DRUCKER GESTOPPT !!") * 16) / 2, 140, "DRUCKER GESTOPPT !!", 0xFFFF, 0x0000);
  disp_string((TFT_WIDTH - strlen("Bitte neu starten !!") * 16) / 2, 180, "Bitte neu starten !!", 0xFFFF, 0x0000);
}
